...
* discrete stage -> continuous stage: germination of seeds from thh seed bank to become individuals of a given above ground stem height. 
...
n=80 # dimensions of the matrix, change to 80 to match nBigMatrix in Merow code, now plots match
